...
const OPS_ROWS: OpsRow[] = [
  { time: "08:00", patient: "María López", specialty: "Perio", provider: "Dr. Barrantes", procedure: "Perio maintenance", status: "completed" },
  { time: "09:30", patient: "David Chen", specialty: "Implant", provider: "Dr. Rodríguez", procedure: "AOX planning", status: "confirmed" },
  { time: "10:00", patient: "Sofía Castro", specialty: "General", provider: "Dr. Barrantes", procedure: "Recall + exam", status: "scheduled" },
  { time: "11:00", patient: "Ana Rodríguez", specialty: "Ortho", provider: "Dr. Park", procedure: "Aligner check", status: "confirmed" },
  { time: "12:15", patient: "Nazareti Cova", specialty: "General", provider: "Dr. Chen", procedure: "Composite restore", status: "completed" },
  { time: "13:00", patient: "Marco Vargas", specialty: "Prosth", provider: "Dr. Chen", procedure: "Crown consult", status: "scheduled" },
  { time: "14:00", patient: "Carlos Vega", specialty: "Endo", provider: "Dr. Barrantes", procedure: "Pain UR6 triage", status: "emergency" },
];

function TabPill({ active, label }: { active?: boolean; label: string }) {
  return (
    <span
...
export default function OperationsHubClient() {
  ...
  const rows = useMemo(() => OPS_ROWS.filter((r) => r.status === tab), [tab]);
                ...
                <tbody>
                  {rows.map((r, idx) => (
                    ...
                    >
                      ...
                      <td className="py-2 pr-4 text-sky-300">{r.patient}</td>
